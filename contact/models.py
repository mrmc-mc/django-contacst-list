...
class DateTimeAbstractModel(models.Model):
        ...
        created_at = models.DateTimeField(verbose_name='Creaion Time', auto_now=False, auto_now_add=False)
...
class Contact(DateTimeAbstractModel):
        ...
        home = models.CharField(verbose_name='Home Number', blank=True, null=True)
